...
<head>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-3N91F5N017"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-3N91F5N017');
</script>
<body class="home">
        ...
        <div class="hero d-flex justify-content-center align-items-center" 
            ...
            <div class="container">
                ...
                <div class="center-container" style="display: flex; justify-content: center;">
                    <a href="https://drive.google.com/file/d/19e-7iqItMdoeZGTXyGHijD7PGuUsugIa/view?usp=drive_link" target="_blank" style="display:inline-block; width: 400px;">
                        <img src="QR2025Movil.png" alt="qr" style="width: 70%; height: auto; display: block;"/>
                    </a>
                </div>
